# Olá, eu sou o Yuri Kyan 👋

🎓 Ciência da Computação - 1º Período
💻 C# | Python | Cybersecurity & Engenharia Reversa
📍 Linhares - ES
...
### 🛠️ Tech Stack
- **Linguagens:** C#, Python
- **Foco:** Cybersecurity, Reverse Engineering, Estrutura de Dados
- **Ferramentas:** Git, GitHub, Ghidra, ILSpy

### 📜 Certificações
- **Cisco - Introdução à Cibersegurança** (Set/2026) - ID: 3f940281-14ff-4897-89df-2a39d5227646
